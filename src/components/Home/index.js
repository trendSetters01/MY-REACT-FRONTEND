...
function Home({ accountAddress }) {
  ...
  //         <section className="nft-benefits bg-white p-4 shadow rounded-lg">
  ...
  //         <section className="explore-token bg-white p-4 shadow rounded-lg">
  //           <h2 className="text-2xl font-semibold mb-4">
  ...
  // <section className="tokenomics bg-white p-4 shadow rounded-lg">
  //   <h2 className="text-2xl font-semibold mb-4">
